      ...
      <div class="im_box mt--30">
        <div class="thumbnail">
          <router-link to="/blog-details">
            <img class="w-100" :src="item.image" alt="Blog Images" />
          </router-link>
        </div>
        <div class="content">
          <div class="inner">
            <div class="content_heading">
              ...
              <h5 class="heading-subtitle">
                <router-link to="/blog">{{ item.location }}</router-link>
              </h5>
            </div>
  ...
  export default {
    ...
    async mounted() {
      ...
      this.events.forEach(function(event, index){
        if(index==0){
          event.image = require("../../assets/images/events/gsb.jpg");
        } else {
          event.image = require("../../assets/images/events/kelp.jpg");
        }
      });
      ...
      this.events.push({
        ...
        'image': require("../../assets/images/events/boat.jpg"),
      })
    }
  };
</script>
